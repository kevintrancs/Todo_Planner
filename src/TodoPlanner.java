...
public class TodoPlanner {
	...
	public static Vector<Todo> listOfTodos = new Vector<Todo>();
	 ...
	 */
	public static Vector<Todo> getList() {
		return listOfTodos;
	}
	...
	public static void copyArrayList(ArrayList<Todo> l){
		listOfTodos = (Vector<Todo>)l.clone();
	}
	...
	public static Vector<String> getTodoTitleList(){
		Vector<String> vect = new Vector<String>();
		for(Todo t: listOfTodos){
			vect.addElement(t.getTitle());
		}
		return vect;
